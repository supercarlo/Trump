...
public class Filters {
    ...
    // If a Orders manually manipulates paths and forgets to add
    // a trailing slash, redirect the Orders to the correct path
    ...
    // The locale is extracted from the request and saved to the Orders's session
